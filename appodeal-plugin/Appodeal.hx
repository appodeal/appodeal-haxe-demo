...
class Appodeal  {
    ...
    #if ios
        private static var _appodealEventsiOS = cpp.Lib.load("appodeal", "appodeal_events" , 1);
        private static var _disableLocationPermissionCheckiOS = cpp.Lib.load("appodeal", "appodeal_disableLocationPermissionCheck", 0);
        private static var _disableNetworkForAdTypeiOS = cpp.Lib.load("appodeal", "appodeal_disableNetworkForAdType", 2);
        private static var _setAutoCacheiOS = cpp.Lib.load("appodeal", "appodeal_setAutoCache" , 2);
        private static var _isPrecacheiOS = cpp.Lib.load("appodeal", "appodeal_isPrecache", 1);
        private static var _initializeiOS = cpp.Lib.load("appodeal", "appodeal_initialize", 2);
        private static var _enableInterstitialCallbacksiOS = cpp.Lib.load("appodeal", "appodeal_enableInterstitialCallbacks", 0);
        private static var _enableBannerCallbacksiOS = cpp.Lib.load("appodeal", "appodeal_enableBannerCallbacks", 0);
        private static var _enableSkippableVideoCallbacksiOS = cpp.Lib.load("appodeal", "appodeal_enableSkippableVideoCallbacks" , 0);
        private static var _enableRewardedVideoCallbacksiOS = cpp.Lib.load("appodeal", "appodeal_enableRewardedVideoCallbacks", 0);
        private static var _enableNonSkippableVideoCallbacksiOS = cpp.Lib.load("appodeal", "appodeal_enableNonSkippableVideoCallbacks", 0);
        private static var _showiOS = cpp.Lib.load("appodeal", "appodeal_show" , 1);
        private static var _showWithPlacementiOS = cpp.Lib.load("appodeal", "appodeal_showWithPlacement", 2);
        private static var _cacheiOS = cpp.Lib.load("appodeal", "appodeal_cache", 1);
        private static var _hideiOS = cpp.Lib.load("appodeal", "appodeal_hide" , 1);
        
        private static var _setLoggingiOS = cpp.Lib.load("appodeal", "appodeal_setLogging", 1);
        private static var _setTestingiOS = cpp.Lib.load("appodeal", "appodeal_setTesting", 1);
        private static var _resetUUIDiOS = cpp.Lib.load("appodeal", "appodeal_resetUUID" , 0);
        private static var _getVersioniOS = cpp.Lib.load("appodeal", "appodeal_getVersion", 0);
        private static var _isLoadediOS = cpp.Lib.load("appodeal", "appodeal_isLoaded", 1);
        
        private static var _setCustomRuleiOS = cpp.Lib.load("appodeal", "appodeal_setCustomRule" , 1);
        
        private static var _confirmiOS = cpp.Lib.load("appodeal", "appodeal_confirm", 1);
        
        private static var _setSmartBannersiOS = cpp.Lib.load("appodeal", "appodeal_setSmartBanners", 1);
        private static var _setBannerBackgoundiOS = cpp.Lib.load("appodeal", "appodeal_setBannerBackgound" , 1);
        private static var _setBannerAnimationiOS = cpp.Lib.load("appodeal", "appodeal_setBannerAnimation" , 1);
        
        private static var _setUserIdiOS = cpp.Lib.load("appodeal", "appodeal_setUserId", 1);
        private static var _setEmailiOS = cpp.Lib.load("appodeal", "appodeal_setEmail", 1);
        private static var _setBirthdayiOS = cpp.Lib.load("appodeal", "appodeal_setBirthday" , 1);
        private static var _setAgeiOS = cpp.Lib.load("appodeal", "appodeal_setAge", 1);
        private static var _setGenderiOS = cpp.Lib.load("appodeal", "appodeal_setGender", 1);
        private static var _setOccupationiOS = cpp.Lib.load("appodeal", "appodeal_setOccupation" , 1);
        private static var _setRelationiOS = cpp.Lib.load("appodeal", "appodeal_setRelation", 1);
        private static var _setSmokingiOS = cpp.Lib.load("appodeal", "appodeal_setSmoking", 1);
        private static var _setAlcoholiOS = cpp.Lib.load("appodeal", "appodeal_setAlcohol" , 1);
        private static var _setInterestsiOS = cpp.Lib.load("appodeal", "appodeal_setInterests" , 1);
    #end
